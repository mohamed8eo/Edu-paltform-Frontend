...
interface CategoryFormProps {
  ...
  onSubmit: (data: Omit<Category, 'children'>) => void
  isLoading?: boolean
}

export function CategoryForm({ categories, initialData, onSubmit, isLoading }: CategoryFormProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {initialData ? 'Update category details' : 'Create a new category or sub-category'}
        </CardDescription>
      </CardHeader>
      <CardContent>

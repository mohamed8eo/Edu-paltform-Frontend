...
async function getCourseSlug(params: Promise<{ slug: string }>) {
...
export default function CoursePage({
  ...
  useEffect(() => {
    getCourseSlug(params).then((courseSlug) => {
      setSlug(courseSlug);
      fetchCourseAndLessons(courseSlug);
    });
  }, [params]);

  const fetchCourseAndLessons = async (courseSlug: string) => {
    setLoading(true);
    setError(null);
    try {
      // Fetch course details from /api/admin/course/all and find by slug
      const coursesResponse = await fetch("/api/admin/course/all", {
        method: "GET",
        credentials: "include",
      });
      ...
      const foundCourse = courses.find(
        (c: Course) => c.id === courseSlug || c.slug === courseSlug,
      );
      ...
      // Fetch lessons for this course using /course/:slug/lessons
      const lessonsResponse = await fetch(
        `/api/admin/course/${courseSlug}/lessons`,
        {
          method: "GET",
          credentials: "include",
        },
